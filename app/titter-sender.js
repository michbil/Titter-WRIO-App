...
titterSender.comment = function (cred, message, imagePath, done) {
    var twitterClient = new _nodeTwitter2.default.RestClient(_wrio_nconf2.default.get('api:twitterLogin:consumerKey'), _wrio_nconf2.default.get('api:twitterLogin:consumerSecret'), cred.token, cred.tokenSecret);
